...
- Extract just the subject; replace everything else with a plain white background (#FFFFFF)
- ⚠ COLOUR RULE FOR WHITE: use pure white (#FFFFFF) ONLY for the empty background. If the subject wears white, cream, or very light clothing, draw it as warm off-white (#F0E8D8 or similar) — NEVER pure #FFFFFF for any part of the subject itself
...
- Background: plain pure white (#FFFFFF) ONLY
- ⚠ COLOUR RULE FOR WHITE: pure white (#FFFFFF) = background ONLY. If the subject has white or very light clothing, draw it as warm off-white (#F0E8D8) — never pure #FFFFFF for clothing/skin/subject
