...
// Digitizing rule: fills need a 2-3mm underlay foundation for stability/registration
// (prevents puckering, lifts cover stitches). Set STICHAI_FILL_UNDERLAY=0 to disable.
const USE_FILL_UNDERLAY = process.env.STICHAI_FILL_UNDERLAY !== "0";
