...
async function buildMaskPNG(sharp, pixMap, ci, W, H, tuckZone) {
  ...
  const c2=dilateBin(m, tuckZone ? 1 : 2);   // fills +1 base (the +2 omni-grow spilled past open hand/arm edges). Seam-closing is done by the tuck-into-dark pass below (grows only toward outlines), avoiding open-silhouette blobbing.
