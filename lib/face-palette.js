...
function isSkin(r, g, b) {
  ...
  // Warm hue: red→orange→yellow (0–55°) AND magenta-red side (335–360°)
  // also covers some brown tones via low-sat warm.
  if (h <= 55 || h >= 335) return true;
  // Pale/warm-grey skin: low saturation, warm hue, mid brightness
  if (s < 38 && v > 55 && (h <= 70 || h >= 320)) return true;
  return false;
}
